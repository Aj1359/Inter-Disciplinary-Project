...
def plot_prob_vs_samples(all_results, out_dir):
    ...
    for ax, res in zip(axes, all_results):
        ...
        ax.scatter(T_vals, classic, color="#e74c3c", marker='o')
        ax.scatter(T_vals, improved, color="#2196F3", marker='s')
...
def plot_accuracy_vs_t(all_results, out_dir):
    ...
    for (res, cc, ci) in zip(all_results, colors_c, colors_i):
        ...
        ax.scatter(T_vals, c_acc, color=cc, marker='o')
        ax.scatter(T_vals, i_acc, color=ci, marker='s')
...
def plot_error_vs_t(all_results, out_dir):
    ...
    for (res, cc, ci) in zip(all_results, colors_c, colors_i):
        ...
        ax.scatter(T_vals, c_err, color=cc, marker='o')
        ax.scatter(T_vals, i_err, color=ci, marker='s')
...
def plot_time_vs_t(all_results, out_dir):
    ...
    for (res, cc, ci) in zip(all_results, colors_c, colors_i):
        ...
        ax.scatter(T_vals, c_time, color=cc, marker='o')
        ax.scatter(T_vals, i_time, color=ci, marker='s')
